...
1. clone the repository : `git clone https://github.com/forbi/dotfiles.git ~/ ; cd ~/dotfiles`
1. optional, load the submodules running `setup.sh`.
1. setup `stow`, *inception style* : `stow -t ~ stow`  [not needed if used `setup.sh`]
